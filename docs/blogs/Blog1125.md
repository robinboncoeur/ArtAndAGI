...
At this point, the forensic AI lawyer is sobbing. How do you copyright-infringement prosecute a pastel Flux Kontext drawing derivative of an SRPO photoreal derivative of an LLM derivative of a drawing?

While this all seems like a lot of work, you've actually got a setting, a consistent face (via LoRA), attire (which can also be controlled by LoRA) and all that lacks is a story.
...
**08.Nov.2025**  
Just redid that lame comix, just for sh#ts-n-giggles. I didn't improve the story any -- this is really more a proof-of-concept thing -- but the characters and setting are a bit more consistent. Btw, 'reluctance' or even 'cluelessness' are both key components in this flavour of story telling, *selon moi*. 
...
Even an 8 gig card should produce decent results from <a href="/assets/images/workflows/QwenComics.zip" target="_blank">this workflow</a>.
