...
Can't get much happier than that, can you?
...
Just for shits-n-giggles, I took the prompt for the image on the right into OpenAI's image generator. It spat the dummy. When I asked Emily where it balked, she explained:
...
Thanks, Emily. I won't tone down my writing, but I also won't use an online image generator, either.
