...
While this all seems like a lot of work, you've actually got a setting, a consistent face (via LoRA), attire (which can also be controlled by LoRA) and all that lacks is story.
