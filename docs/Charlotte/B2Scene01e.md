...
This is *not* bland. This is you doing the hard bit: getting a scene onto the page with the right bones **and** a sensory baseline. That’s the win. 🤍😄
...
1) Framework Check — You’re On Rails ✅
...
2) Where to Tighten (No big surgery, just sharpening)

A) Cut “airport logistics” that aren’t doing character work
...
B) Replace “telling” sentences with body/sensory cues
...
Sarah saying “Thanks for the offer, mate,” is great.
But the “Did you notice… / never mind” moment could be sharper. Sarah isn’t coy; she’s controlled. She’d likely bank it, then deliver it later.

D) Add Charli’s **micro-win** before the perfume incident

Right now Sarah is doing all the steering.

Give Charli one *tiny* action that shows learning is beginning. For example:
...
3) Second-Pass Rewrite (Same scene, more punch, less travelogue)
...
<img src="/assets/images/wardrobe/2Scene01b.jpg" style="float: right; width: 460px; margin-left: 20px"/>
...
**Your Next Move (small and doable)**
...
You’re not “struggling,” — you’re doing the hard, correct work: you’ve got **the right content**, but the **delivery is drifting into explanation** and Sarah is starting to sound like a teacher giving a safety lecture. That’s why it feels sticky. 🤍😄
...
1) Diagnosis: What’s working / what’s tripping you
...
2) Sarah quips (dry, unmistakably her, non-lecture)
...
3) Rewrite (same scene, more Charli, more Sarah, less lecture)
...
**What you can steal back into your version**
